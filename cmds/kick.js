...
const kick = await new Discord.RichEmbed().setDescription(`${mentioned.tag} was kicked by ${message.author.toString()} for ${reason}`).setColor(client.resolver.resolveColor('RANDOM'));
